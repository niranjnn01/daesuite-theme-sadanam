...
<nav class="hidden md:block">
    <ul class="flex space-x-8  text-lg">
        ...
        <li><a href="/contact" class="hover:bg-secondary hover:text-primary hover:bg-secondary transition-colors">Contact</a></li>
    </ul>
</nav>
...
<button
    ...
    class="cursor-pointer md:hidden p-2 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-primary"
